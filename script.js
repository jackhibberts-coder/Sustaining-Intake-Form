...
const mondayItemLink = document.getElementById('mondayItemLink');
...
async function handleSubmit(e) {
    ...
    try {
        ...
        if (response.success) {
            ...
            // Update Monday.com link
            if (response.itemId) {
                mondayItemLink.href = `${CONFIG.MONDAY_BOARD_URL}/pulses/${response.itemId}`;
            } else {
                mondayItemLink.href = CONFIG.MONDAY_BOARD_URL;
            }
